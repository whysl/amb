  ...
  <div class="page">
    <div class="top-bar">
      <div class="top-left">
        ...
        <span class="top-title">公司审核</span>
      </div>
...
const fetchPending = async () => {
  try { const { data } = await http.get('/forms/pending/company'); pendingList.value = data } catch (e) {}
}
...
const confirmReview = async () => {
  ...
  try {
    await http.put(`/forms/${currentForm.value.id}/company-review`, { action: currentAction.value, comment: comment.value || null })
